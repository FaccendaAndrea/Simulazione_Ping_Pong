  ...
  return (
    <div style={{minHeight:'100dvh',minWidth:'100vw',display:'flex',justifyContent:'center',alignItems:'center',background:'#f5f6fa'}}>
      <div style={{background:'#fff',padding:'2.5em 2em',borderRadius:'14px',boxShadow:'0 2px 24px #0002',width:'100%',maxWidth:400,display:'flex',flexDirection:'column',alignItems:'center'}}>
        ...
        <h2 style={{textAlign:'center',marginBottom:'0.5em',color:'#222',fontWeight:700}}>Accedi al tuo account</h2>
        <p style={{textAlign:'center',marginBottom:'1.5em',color:'#222',fontSize:'1em'}}>Inserisci le tue credenziali per continuare</p>
        ...
        <p style={{marginTop:'1.5em',textAlign:'center',fontSize:'0.98em',color:'#222'}}>Non hai un account? <a href="/register" style={{color:'#0984e3',fontWeight:500,textDecoration:'underline'}}>Registrati</a></p>
      </div>
    </div>
  );
} 